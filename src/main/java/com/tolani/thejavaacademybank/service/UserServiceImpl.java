...
public class UserServiceImpl implements UserService {
    ...
    private int addingNumbers(int num1, int num2){
    ...
    public BankResponse debitAccount(CreditDebitRequest request) {
        ...
        //check if the amount you need to withdraw is not more than the current account balance
        boolean isAccountExist = userRepository.existsByAccountNumber(request.getAccountNumber());
        if (!isAccountExist) {
            return BankResponse.builder()
                    .responseCode(AccountUtils.ACCOUNT_EXISTS_CODE)
...
//        String recipientUsername = destinationAccountUser.getFirstName() + " " + destinationAccountUser.getLastName() + " " + destinationAccountUser.getFirstName();
